...
{
	[Serializable]
	public class TaskDataObject : DataObject
	{		
		/// <summary>
		/// Default config ID for any instances of this class
		/// </summary>
		static public string CONFIGID_DEFAULT			= "3";

		/// <summary>
		/// Schema in default configuration.
		/// </summary>
		static public string SCHEMA_DEFAULT				= "TTask";
		...
		/// Column used to store owner of the calendar item.
		/// </summary>
		static public string COLUMN_BEGINDT				= "begindt";

		/// <summary>
		/// Column used to store owner of the calendar item.
		/// </summary>
		static public string COLUMN_DUEDT				= "duedt";


		/// <summary>
		/// Column used to store owner of the calendar item.
		/// </summary>
		static public string COLUMN_PENDINGFLG			= "pendingflg";
		...
		/// Class ID
		/// </summary>
		new protected static string g_classID			= "Engine.TaskDataObject";	
		...
		{
			g_creator = new CreateObjectDelegator(TaskDataObject.CreateInstance);
