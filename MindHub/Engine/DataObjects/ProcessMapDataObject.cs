...
{
	[Serializable]
	public class ProcessMapDataObject : DataObject
	{		
		/// <summary>
		/// Default config ID for any instances of this class
		/// </summary>
		static public string CONFIGID_DEFAULT			= "4";

		/// <summary>
		/// Schema in default configuration.
		/// </summary>
		static public string SCHEMA_DEFAULT				= "TProcessMap";
		...
		/// Class ID
		/// </summary>
		new protected static string g_classID			= "Engine.ProcessMapDataObject";	
		...
		{
			return new ProcessMapDataObject();
		}
		...
		{
			g_creator = new CreateObjectDelegator(ProcessMapDataObject.CreateInstance);
