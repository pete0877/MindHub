...
<CFSET CurrID = ListGetAt(Session.AddContent.ReqContentTypes, URL.CurrPos)>
<CFSET CurrName = ListGetAt(Session.AddContent.ReqContentTypeNames, URL.CurrPos)>
...
<FORM ACTION="addcontent2.req.cfm" METHOD="POST">
...
<TR>
	...
	<CFELSE>
		...
		<CFOUTPUT>
			...
			<CFELSE>
				<TEXTAREA COLS="40" ROWS="12" NAME="Type#Replace(CurrID,"-","_","ALL")#">#PreviousText#</TEXTAREA>
			</CFIF>
		</CFOUTPUT>
