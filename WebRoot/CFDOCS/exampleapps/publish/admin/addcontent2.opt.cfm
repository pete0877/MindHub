<CFIF evaluate("Type" & Replace(CurrItem,"-","_","ALL")) IS "|0">
	...
	<FORM ACTION="addcontent2a.opt.cfm" METHOD="POST" ENCTYPE="multipart/form-data">
...
<CFELSE>
	...
	<CFIF CurrPos IS ListLen(Session.AddContent.OptContentTypes)>
		<CFLOCATION URL="addcontent3.cfm" ADDTOKEN="NO">
	<CFELSE>
		<CFSET NextPos = CurrPos + 1>
		<CFLOCATION URL="addcontent.opt.cfm?CurrPos=#NextPos#" ADDTOKEN="NO">
	</CFIF>
