...
<CFIF File.FileExisted>
	...
	<CFOUTPUT>
		<SCRIPT LANGUAGE="JAVASCRIPT">
		   ...
		   location.replace('addcontent2.req.cfm?CurrItem=#CurrItem#&CurrPos=#CurrPos#&Type#Replace(CurrItem,"-","_","ALL")#=#URLEncodedFormat("|0")#');
		</SCRIPT>
...
<CFELSE>
	...
	<CFLOCATION URL="addcontent2.req.cfm?CurrItem=#CurrItem#&CurrPos=#CurrPos#&Type#Replace(CurrItem,"-","_","ALL")#=#File.ServerFile#" ADDTOKEN="NO">
